...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<h4 class="text-dark"><strong>Checkout Page</strong></h4>
			<form method="post" id="checkoutform" style="position: relative;" >
				...
				<div class="form-group">
					...
					<input type="text" name="mobile" class="form-control" placeholder="Enter Mobile Number" required pattern="^[0-9]\d{10}$">
