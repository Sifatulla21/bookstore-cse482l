...
$users="";
 ...
 if (isset($_POST['all'])) {
   ...
   {
     $output .= '
    <h4 class="text-dark"> Total Books: '.$books.'</h4>
     <table class="table">
       <tr>
       <th>book_id</th>
       <th>Book Name</th>
 ...
 <div class="container">
   <div class="row">
     ...
     <input class="btn btn-outline-dark my-2 my-sm-0" name="q" type="submit" value="Search"> &nbsp;&nbsp;
     <button class="btn btn-outline-dark my-2 my-sm-0" name="all" type="submit">View All</button>
   </form>
      <br><br>
